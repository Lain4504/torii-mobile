...
class _LessonScreenState extends State<LessonScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Bài 2: Nguyên âm Hiragana', style: TextStyle(color: Colors.black, fontSize: 18)),
        backgroundColor: Colors.white,
        elevation: 0,
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          const Text('10:24 / 20:00', style: TextStyle(color: Colors.white, fontSize: 12)),
                          const Spacer(),
              ...
              children: [
                Expanded(
                  child: OutlinedButton(
                    ...
                    child: const Text('Đánh dấu hoàn thành', style: TextStyle(color: Colors.black87, fontWeight: FontWeight.bold)),
                  ),
                ),
  ...
  Widget _buildVocabItem(String char, String romaji, String meaning) {
    return Container(
      ...
      child: Row(
        children: [
          Text(char, style: const TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Color(0xFFE53935))),
          const SizedBox(width: 16),
          Text(romaji, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
          const Spacer(),
          Text(meaning, style: TextStyle(color: Colors.grey[600])),
        ],
      ),
    );
  }
  ...
  Widget _buildPlaceholderTab(String text) {
    return Center(child: Text(text, style: TextStyle(color: Colors.grey[400])));
  }
}
