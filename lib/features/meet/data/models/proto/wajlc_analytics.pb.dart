...
class AnalyticsDataMsg extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<AnalyticsEventType>(
        ...
        defaultOrMaker: AnalyticsEventType.ANALYTICS_EVENT_TYPE_ROOM,
        valueOf: AnalyticsEventType.valueOf,
        enumValues: AnalyticsEventType.values)
    ..e<AnalyticsEvents>(
        2, _omitFieldNames ? '' : 'eventName', $pb.PbFieldType.OE,
        defaultOrMaker: AnalyticsEvents.ANALYTICS_EVENT_UNKNOWN,
        valueOf: AnalyticsEvents.valueOf,
  ...
  static $pb.PbList<AnalyticsDataMsg> createRepeated() =>
      $pb.PbList<AnalyticsDataMsg>();
  @$core.pragma('dart2js:noInline')
...
class AnalyticsEventValue extends $pb.GeneratedMessage {
  ...
  static $pb.PbList<AnalyticsEventValue> createRepeated() =>
      $pb.PbList<AnalyticsEventValue>();
  @$core.pragma('dart2js:noInline')
...
class AnalyticsEventData extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<AnalyticsEventValue>(
        3, _omitFieldNames ? '' : 'values', $pb.PbFieldType.PM,
  ...
  static $pb.PbList<AnalyticsEventData> createRepeated() =>
      $pb.PbList<AnalyticsEventData>();
  @$core.pragma('dart2js:noInline')
...
class AnalyticsRoomInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<AnalyticsEventData>(
        9, _omitFieldNames ? '' : 'events', $pb.PbFieldType.PM,
  ...
  static $pb.PbList<AnalyticsRoomInfo> createRepeated() =>
      $pb.PbList<AnalyticsRoomInfo>();
  @$core.pragma('dart2js:noInline')
...
class AnalyticsUserInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<AnalyticsEventData>(
        6, _omitFieldNames ? '' : 'events', $pb.PbFieldType.PM,
        subBuilder: AnalyticsEventData.create)
    ..hasRequiredFields = false;
  ...
  static $pb.PbList<AnalyticsUserInfo> createRepeated() =>
      $pb.PbList<AnalyticsUserInfo>();
  @$core.pragma('dart2js:noInline')
...
class AnalyticsResult extends $pb.GeneratedMessage {
  ...
  static $pb.PbList<AnalyticsResult> createRepeated() =>
      $pb.PbList<AnalyticsResult>();
  @$core.pragma('dart2js:noInline')
...
class AnalyticsRedisUserInfo extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AnalyticsRedisUserInfo clone() =>
      AnalyticsRedisUserInfo()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<AnalyticsRedisUserInfo> createRepeated() =>
      $pb.PbList<AnalyticsRedisUserInfo>();
  @$core.pragma('dart2js:noInline')
