...
class CreateAgentDispatchRequest extends $pb.GeneratedMessage {
  ...
  CreateAgentDispatchRequest clone() =>
      CreateAgentDispatchRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<CreateAgentDispatchRequest> createRepeated() =>
      $pb.PbList<CreateAgentDispatchRequest>();
  @$core.pragma('dart2js:noInline')
...
class RoomAgentDispatch extends $pb.GeneratedMessage {
  ...
  static $pb.PbList<RoomAgentDispatch> createRepeated() =>
      $pb.PbList<RoomAgentDispatch>();
  @$core.pragma('dart2js:noInline')
...
class DeleteAgentDispatchRequest extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  DeleteAgentDispatchRequest clone() =>
      DeleteAgentDispatchRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<DeleteAgentDispatchRequest> createRepeated() =>
      $pb.PbList<DeleteAgentDispatchRequest>();
  @$core.pragma('dart2js:noInline')
...
class ListAgentDispatchRequest extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ListAgentDispatchRequest clone() =>
      ListAgentDispatchRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<ListAgentDispatchRequest> createRepeated() =>
      $pb.PbList<ListAgentDispatchRequest>();
  @$core.pragma('dart2js:noInline')
...
class ListAgentDispatchResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..pc<AgentDispatch>(
        1, _omitFieldNames ? '' : 'agentDispatches', $pb.PbFieldType.PM,
        subBuilder: AgentDispatch.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ListAgentDispatchResponse clone() =>
      ListAgentDispatchResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<ListAgentDispatchResponse> createRepeated() =>
      $pb.PbList<ListAgentDispatchResponse>();
  @$core.pragma('dart2js:noInline')
...
class AgentDispatch extends $pb.GeneratedMessage {
  ...
  static $pb.PbList<AgentDispatch> createRepeated() =>
      $pb.PbList<AgentDispatch>();
  @$core.pragma('dart2js:noInline')
...
class AgentDispatchState extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'livekit'),
      createEmptyInstance: create)
    ..pc<$0.Job>(1, _omitFieldNames ? '' : 'jobs', $pb.PbFieldType.PM,
        subBuilder: $0.Job.create)
  ...
  static $pb.PbList<AgentDispatchState> createRepeated() =>
      $pb.PbList<AgentDispatchState>();
  @$core.pragma('dart2js:noInline')
