...
class AudioCodec extends $pb.ProtobufEnum {
  ...
  static const AudioCodec AC_MP3 =
      AudioCodec._(3, _omitEnumNames ? '' : 'AC_MP3');
...
class DataTrackExtensionID extends $pb.ProtobufEnum {
  static const DataTrackExtensionID DTEI_INVALID =
      DataTrackExtensionID._(0, _omitEnumNames ? '' : 'DTEI_INVALID');
  ...
  static final $core.List<DataTrackExtensionID?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 1);
...
class ParticipantInfo_Kind extends $pb.ProtobufEnum {
  ...
  static const ParticipantInfo_Kind CONNECTOR =
      ParticipantInfo_Kind._(7, _omitEnumNames ? '' : 'CONNECTOR');

  /// Bridge participants
  static const ParticipantInfo_Kind BRIDGE =
      ParticipantInfo_Kind._(8, _omitEnumNames ? '' : 'BRIDGE');
...
class ParticipantInfo_KindDetail extends $pb.ProtobufEnum {
  ...
  static const ParticipantInfo_KindDetail CONNECTOR_WHATSAPP =
      ParticipantInfo_KindDetail._(
          2, _omitEnumNames ? '' : 'CONNECTOR_WHATSAPP');
...
class VideoLayer_Mode extends $pb.ProtobufEnum {
  ...
  static const VideoLayer_Mode ONE_SPATIAL_LAYER_PER_STREAM_INCOMPLETE_RTCP_SR =
      VideoLayer_Mode._(
          3,
          _omitEnumNames
              ? ''
