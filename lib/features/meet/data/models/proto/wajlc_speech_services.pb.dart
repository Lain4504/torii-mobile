...
class SpeechToTextTranslationReq extends $pb.GeneratedMessage {
  ...
  SpeechToTextTranslationReq clone() =>
      SpeechToTextTranslationReq()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<SpeechToTextTranslationReq> createRepeated() =>
      $pb.PbList<SpeechToTextTranslationReq>();
  @$core.pragma('dart2js:noInline')
...
class GenerateAzureTokenReq extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GenerateAzureTokenReq clone() =>
      GenerateAzureTokenReq()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<GenerateAzureTokenReq> createRepeated() =>
      $pb.PbList<GenerateAzureTokenReq>();
  @$core.pragma('dart2js:noInline')
...
class GenerateAzureTokenRes extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GenerateAzureTokenRes clone() =>
      GenerateAzureTokenRes()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<GenerateAzureTokenRes> createRepeated() =>
      $pb.PbList<GenerateAzureTokenRes>();
  @$core.pragma('dart2js:noInline')
...
class AzureTokenRenewReq extends $pb.GeneratedMessage {
  ...
  static $pb.PbList<AzureTokenRenewReq> createRepeated() =>
      $pb.PbList<AzureTokenRenewReq>();
  @$core.pragma('dart2js:noInline')
...
class SpeechServiceUserStatusReq extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(4, _omitFieldNames ? '' : 'keyId')
    ..e<SpeechServiceUserStatusTasks>(
        5, _omitFieldNames ? '' : 'task', $pb.PbFieldType.OE,
        defaultOrMaker:
            SpeechServiceUserStatusTasks.SPEECH_TO_TEXT_SESSION_STARTED,
        valueOf: SpeechServiceUserStatusTasks.valueOf,
        enumValues: SpeechServiceUserStatusTasks.values)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  SpeechServiceUserStatusReq clone() =>
      SpeechServiceUserStatusReq()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<SpeechServiceUserStatusReq> createRepeated() =>
      $pb.PbList<SpeechServiceUserStatusReq>();
  @$core.pragma('dart2js:noInline')
