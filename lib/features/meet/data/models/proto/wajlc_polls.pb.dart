...
class ActivatePollsReq extends $pb.GeneratedMessage {
  ...
  static $pb.PbList<ActivatePollsReq> createRepeated() =>
      $pb.PbList<ActivatePollsReq>();
  @$core.pragma('dart2js:noInline')
...
class CreatePollReq extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<CreatePollOptions>(
        5, _omitFieldNames ? '' : 'options', $pb.PbFieldType.PM,
  ...
  static $pb.PbList<CreatePollReq> createRepeated() =>
      $pb.PbList<CreatePollReq>();
  @$core.pragma('dart2js:noInline')
...
class CreatePollOptions extends $pb.GeneratedMessage {
  ...
  static $pb.PbList<CreatePollOptions> createRepeated() =>
      $pb.PbList<CreatePollOptions>();
  @$core.pragma('dart2js:noInline')
...
class SubmitPollResponseReq extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  SubmitPollResponseReq clone() =>
      SubmitPollResponseReq()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<SubmitPollResponseReq> createRepeated() =>
      $pb.PbList<SubmitPollResponseReq>();
  @$core.pragma('dart2js:noInline')
...
class ClosePollReq extends $pb.GeneratedMessage {
  ...
  static $pb.PbList<ClosePollReq> createRepeated() =>
      $pb.PbList<ClosePollReq>();
  @$core.pragma('dart2js:noInline')
...
class PollResponsesResultOptions extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  PollResponsesResultOptions clone() =>
      PollResponsesResultOptions()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<PollResponsesResultOptions> createRepeated() =>
      $pb.PbList<PollResponsesResultOptions>();
  @$core.pragma('dart2js:noInline')
...
class PollResponsesResult extends $pb.GeneratedMessage {
  ...
  static $pb.PbList<PollResponsesResult> createRepeated() =>
      $pb.PbList<PollResponsesResult>();
  @$core.pragma('dart2js:noInline')
...
class PollResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<PollInfo>(7, _omitFieldNames ? '' : 'polls', $pb.PbFieldType.PM,
  ...
  static $pb.PbList<PollResponse> createRepeated() =>
      $pb.PbList<PollResponse>();
  @$core.pragma('dart2js:noInline')
