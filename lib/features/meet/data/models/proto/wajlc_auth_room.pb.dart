...
class GetActiveRoomInfoReq extends $pb.GeneratedMessage {
  ...
  GetActiveRoomInfoReq clone() =>
      GetActiveRoomInfoReq()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<GetActiveRoomInfoReq> createRepeated() =>
      $pb.PbList<GetActiveRoomInfoReq>();
  @$core.pragma('dart2js:noInline')
...
class ActiveRoomInfoRes extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$0.ParticipantInfo>(
        4, _omitFieldNames ? '' : 'participantsInfo', $pb.PbFieldType.PM,
  ...
  static $pb.PbList<ActiveRoomInfoRes> createRepeated() =>
      $pb.PbList<ActiveRoomInfoRes>();
  @$core.pragma('dart2js:noInline')
...
class ActiveRoomInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.int>(
        9, _omitFieldNames ? '' : 'isBreakoutRoom', $pb.PbFieldType.O3)
  ...
  static $pb.PbList<ActiveRoomInfo> createRepeated() =>
      $pb.PbList<ActiveRoomInfo>();
  @$core.pragma('dart2js:noInline')
...
class IsRoomActiveReq extends $pb.GeneratedMessage {
  ...
  static $pb.PbList<IsRoomActiveReq> createRepeated() =>
      $pb.PbList<IsRoomActiveReq>();
  @$core.pragma('dart2js:noInline')
...
class IsRoomActiveRes extends $pb.GeneratedMessage {
  ...
  static $pb.PbList<IsRoomActiveRes> createRepeated() =>
      $pb.PbList<IsRoomActiveRes>();
  @$core.pragma('dart2js:noInline')
...
class ActiveRoomWithParticipant extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ActiveRoomWithParticipant clone() =>
      ActiveRoomWithParticipant()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<ActiveRoomWithParticipant> createRepeated() =>
      $pb.PbList<ActiveRoomWithParticipant>();
  @$core.pragma('dart2js:noInline')
...
class GetActiveRoomInfoRes extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetActiveRoomInfoRes clone() =>
      GetActiveRoomInfoRes()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<GetActiveRoomInfoRes> createRepeated() =>
      $pb.PbList<GetActiveRoomInfoRes>();
  @$core.pragma('dart2js:noInline')
...
class GetActiveRoomsInfoRes extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOB(1, _omitFieldNames ? '' : 'status')
    ..aOS(2, _omitFieldNames ? '' : 'msg')
    ..pc<ActiveRoomWithParticipant>(
        3, _omitFieldNames ? '' : 'rooms', $pb.PbFieldType.PM,
        subBuilder: ActiveRoomWithParticipant.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetActiveRoomsInfoRes clone() =>
      GetActiveRoomsInfoRes()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<GetActiveRoomsInfoRes> createRepeated() =>
      $pb.PbList<GetActiveRoomsInfoRes>();
  @$core.pragma('dart2js:noInline')
...
class PastRoomInfo extends $pb.GeneratedMessage {
  ...
  static $pb.PbList<PastRoomInfo> createRepeated() =>
      $pb.PbList<PastRoomInfo>();
  @$core.pragma('dart2js:noInline')
...
class FetchPastRoomsReq extends $pb.GeneratedMessage {
  ...
  static $pb.PbList<FetchPastRoomsReq> createRepeated() =>
      $pb.PbList<FetchPastRoomsReq>();
  @$core.pragma('dart2js:noInline')
...
class FetchPastRoomsResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(4, _omitFieldNames ? '' : 'orderBy')
    ..pc<PastRoomInfo>(
        5, _omitFieldNames ? '' : 'roomsList', $pb.PbFieldType.PM,
        subBuilder: PastRoomInfo.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  FetchPastRoomsResult clone() =>
      FetchPastRoomsResult()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<FetchPastRoomsResult> createRepeated() =>
      $pb.PbList<FetchPastRoomsResult>();
  @$core.pragma('dart2js:noInline')
...
class FetchPastRoomsRes extends $pb.GeneratedMessage {
  ...
  static $pb.PbList<FetchPastRoomsRes> createRepeated() =>
      $pb.PbList<FetchPastRoomsRes>();
  @$core.pragma('dart2js:noInline')
...
class GetClientFilesRes extends $pb.GeneratedMessage {
  factory GetClientFilesRes({
    ...
    if (staticAssetsPath != null) result.staticAssetsPath = staticAssetsPath;
    return result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(7, _omitFieldNames ? '' : 'staticAssetsPath')
    ..hasRequiredFields = false;
  ...
  static $pb.PbList<GetClientFilesRes> createRepeated() =>
      $pb.PbList<GetClientFilesRes>();
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(7)
  $core.String get staticAssetsPath => $_getSZ(6);
  @$pb.TagNumber(7)
  set staticAssetsPath($core.String value) => $_setString(6, value);
  @$pb.TagNumber(7)
  $core.bool hasStaticAssetsPath() => $_has(6);
  @$pb.TagNumber(7)
  void clearStaticAssetsPath() => $_clearField(7);
}
