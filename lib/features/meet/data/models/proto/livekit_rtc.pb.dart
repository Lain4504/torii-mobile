...
class SignalRequest extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('This field is deprecated.')
    ...
    if (updateAudioTrack != null) {
      $result.updateAudioTrack = updateAudioTrack;
    }
    if (updateVideoTrack != null) {
      $result.updateVideoTrack = updateVideoTrack;
    }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SignalRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'livekit'), createEmptyInstance: create)
    ...
    ..aOM<PublishDataTrackRequest>(19, _omitFieldNames ? '' : 'publishDataTrackRequest', subBuilder: PublishDataTrackRequest.create)
    ..aOM<UnpublishDataTrackRequest>(20, _omitFieldNames ? '' : 'unpublishDataTrackRequest', subBuilder: UnpublishDataTrackRequest.create)
    ..aOM<UpdateDataSubscription>(21, _omitFieldNames ? '' : 'updateDataSubscription', subBuilder: UpdateDataSubscription.create)
  ...
  @$pb.TagNumber(17)
  void clearUpdateAudioTrack() => clearField(17);
  @$pb.TagNumber(17)
  ...
  @$pb.TagNumber(18)
  void clearUpdateVideoTrack() => clearField(18);
  @$pb.TagNumber(18)
  ...
  @$pb.TagNumber(19)
  set publishDataTrackRequest(PublishDataTrackRequest v) { setField(19, v); }
  @$pb.TagNumber(19)
  $core.bool hasPublishDataTrackRequest() => $_has(17);
  @$pb.TagNumber(19)
  void clearPublishDataTrackRequest() => clearField(19);
  @$pb.TagNumber(19)
  PublishDataTrackRequest ensurePublishDataTrackRequest() => $_ensure(17);

  /// Unpublish a data track
  @$pb.TagNumber(20)
  UnpublishDataTrackRequest get unpublishDataTrackRequest => $_getN(18);
  @$pb.TagNumber(20)
  set unpublishDataTrackRequest(UnpublishDataTrackRequest v) { setField(20, v); }
  @$pb.TagNumber(20)
  $core.bool hasUnpublishDataTrackRequest() => $_has(18);
  @$pb.TagNumber(20)
  void clearUnpublishDataTrackRequest() => clearField(20);
  @$pb.TagNumber(20)
  UnpublishDataTrackRequest ensureUnpublishDataTrackRequest() => $_ensure(18);

  /// Update subscription state for one or more data tracks
  @$pb.TagNumber(21)
  UpdateDataSubscription get updateDataSubscription => $_getN(19);
  @$pb.TagNumber(21)
  set updateDataSubscription(UpdateDataSubscription v) { setField(21, v); }
  @$pb.TagNumber(21)
  $core.bool hasUpdateDataSubscription() => $_has(19);
  @$pb.TagNumber(21)
  void clearUpdateDataSubscription() => clearField(21);
  @$pb.TagNumber(21)
...
class SignalResponse extends $pb.GeneratedMessage {
  ...
  static const $core.Map<$core.int, SignalResponse_Message> _SignalResponse_MessageByTag = {
    ...
    25 : SignalResponse_Message.mediaSectionsRequirement,
    26 : SignalResponse_Message.subscribedAudioCodecUpdate,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SignalResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'livekit'), createEmptyInstance: create)
    ...
    ..aOM<MediaSectionsRequirement>(25, _omitFieldNames ? '' : 'mediaSectionsRequirement', subBuilder: MediaSectionsRequirement.create)
    ..aOM<SubscribedAudioCodecUpdate>(26, _omitFieldNames ? '' : 'subscribedAudioCodecUpdate', subBuilder: SubscribedAudioCodecUpdate.create)
    ..aOM<PublishDataTrackResponse>(27, _omitFieldNames ? '' : 'publishDataTrackResponse', subBuilder: PublishDataTrackResponse.create)
    ..aOM<UnpublishDataTrackResponse>(28, _omitFieldNames ? '' : 'unpublishDataTrackResponse', subBuilder: UnpublishDataTrackResponse.create)
    ..aOM<DataTrackSubscriberHandles>(29, _omitFieldNames ? '' : 'dataTrackSubscriberHandles', subBuilder: DataTrackSubscriberHandles.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(22)
  set requestResponse(RequestResponse v) { setField(22, v); }
  @$pb.TagNumber(22)
  ...
  @$pb.TagNumber(23)
  set trackSubscribed(TrackSubscribed v) { setField(23, v); }
  @$pb.TagNumber(23)
  ...
  @$pb.TagNumber(24)
  set roomMoved(RoomMovedResponse v) { setField(24, v); }
  @$pb.TagNumber(24)
  $core.bool hasRoomMoved() => $_has(22);
  @$pb.TagNumber(24)
  void clearRoomMoved() => clearField(24);
  @$pb.TagNumber(24)
  ...
  @$pb.TagNumber(25)
  set mediaSectionsRequirement(MediaSectionsRequirement v) { setField(25, v); }
  @$pb.TagNumber(25)
  $core.bool hasMediaSectionsRequirement() => $_has(23);
  @$pb.TagNumber(25)
  void clearMediaSectionsRequirement() => clearField(25);
  @$pb.TagNumber(25)
  MediaSectionsRequirement ensureMediaSectionsRequirement() => $_ensure(23);
  ...
  @$pb.TagNumber(26)
  set subscribedAudioCodecUpdate(SubscribedAudioCodecUpdate v) { setField(26, v); }
  @$pb.TagNumber(26)
  $core.bool hasSubscribedAudioCodecUpdate() => $_has(24);
  @$pb.TagNumber(26)
  void clearSubscribedAudioCodecUpdate() => clearField(26);
  @$pb.TagNumber(26)
  SubscribedAudioCodecUpdate ensureSubscribedAudioCodecUpdate() => $_ensure(24);

  /// Sent in response to `PublishDataTrackRequest`.
  @$pb.TagNumber(27)
  PublishDataTrackResponse get publishDataTrackResponse => $_getN(25);
  @$pb.TagNumber(27)
  set publishDataTrackResponse(PublishDataTrackResponse v) { setField(27, v); }
  @$pb.TagNumber(27)
  $core.bool hasPublishDataTrackResponse() => $_has(25);
  @$pb.TagNumber(27)
  void clearPublishDataTrackResponse() => clearField(27);
  @$pb.TagNumber(27)
  PublishDataTrackResponse ensurePublishDataTrackResponse() => $_ensure(25);
  ...
  @$pb.TagNumber(28)
  set unpublishDataTrackResponse(UnpublishDataTrackResponse v) { setField(28, v); }
  @$pb.TagNumber(28)
  $core.bool hasUnpublishDataTrackResponse() => $_has(26);
  @$pb.TagNumber(28)
  void clearUnpublishDataTrackResponse() => clearField(28);
  @$pb.TagNumber(28)
  UnpublishDataTrackResponse ensureUnpublishDataTrackResponse() => $_ensure(26);
  ...
  @$pb.TagNumber(29)
  set dataTrackSubscriberHandles(DataTrackSubscriberHandles v) { setField(29, v); }
  @$pb.TagNumber(29)
  $core.bool hasDataTrackSubscriberHandles() => $_has(27);
  @$pb.TagNumber(29)
  void clearDataTrackSubscriberHandles() => clearField(29);
  @$pb.TagNumber(29)
...
class SimulcastCodec extends $pb.GeneratedMessage {
  factory SimulcastCodec({
    ...
    $2.VideoLayer_Mode? videoLayerMode,
  }) {
    final $result = create();
    if (codec != null) {
      $result.codec = codec;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SimulcastCodec', package: const $pb.PackageName(_omitMessageNames ? '' : 'livekit'), createEmptyInstance: create)
    ...
    ..pc<$2.VideoLayer>(4, _omitFieldNames ? '' : 'layers', $pb.PbFieldType.PM, subBuilder: $2.VideoLayer.create)
  ...
  @$pb.TagNumber(5)
  $2.VideoLayer_Mode get videoLayerMode => $_getN(3);
  @$pb.TagNumber(5)
  set videoLayerMode($2.VideoLayer_Mode v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasVideoLayerMode() => $_has(3);
  @$pb.TagNumber(5)
...
class AddTrackRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AddTrackRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'livekit'), createEmptyInstance: create)
    ...
    ..e<$2.TrackType>(3, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $2.TrackType.AUDIO, valueOf: $2.TrackType.valueOf, enumValues: $2.TrackType.values)
    ...
    ..e<$2.TrackSource>(8, _omitFieldNames ? '' : 'source', $pb.PbFieldType.OE, defaultOrMaker: $2.TrackSource.UNKNOWN, valueOf: $2.TrackSource.valueOf, enumValues: $2.TrackSource.values)
    ..pc<$2.VideoLayer>(9, _omitFieldNames ? '' : 'layers', $pb.PbFieldType.PM, subBuilder: $2.VideoLayer.create)
    ...
    ..e<$2.Encryption_Type>(14, _omitFieldNames ? '' : 'encryption', $pb.PbFieldType.OE, defaultOrMaker: $2.Encryption_Type.NONE, valueOf: $2.Encryption_Type.valueOf, enumValues: $2.Encryption_Type.values)
    ..aOS(15, _omitFieldNames ? '' : 'stream')
    ..e<$2.BackupCodecPolicy>(16, _omitFieldNames ? '' : 'backupCodecPolicy', $pb.PbFieldType.OE, defaultOrMaker: $2.BackupCodecPolicy.PREFER_REGRESSION, valueOf: $2.BackupCodecPolicy.valueOf, enumValues: $2.BackupCodecPolicy.values)
    ..pc<$2.AudioTrackFeature>(17, _omitFieldNames ? '' : 'audioFeatures', $pb.PbFieldType.KE, valueOf: $2.AudioTrackFeature.valueOf, enumValues: $2.AudioTrackFeature.values, defaultEnumValue: $2.AudioTrackFeature.TF_STEREO)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  set type($2.TrackType v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(8)
  set source($2.TrackSource v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(14)
  set encryption($2.Encryption_Type v) { setField(14, v); }
  @$pb.TagNumber(14)
  ...
  @$pb.TagNumber(16)
  set backupCodecPolicy($2.BackupCodecPolicy v) { setField(16, v); }
  @$pb.TagNumber(16)
  ...
  @$pb.TagNumber(17)
  $core.List<$2.AudioTrackFeature> get audioFeatures => $_getList(16);
}

class PublishDataTrackRequest extends $pb.GeneratedMessage {
  factory PublishDataTrackRequest({
    $core.int? pubHandle,
    $core.String? name,
    $2.Encryption_Type? encryption,
  }) {
  ...
  PublishDataTrackRequest._() : super();
  factory PublishDataTrackRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory PublishDataTrackRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PublishDataTrackRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'livekit'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'pubHandle', $pb.PbFieldType.OU3)
    ..aOS(2, _omitFieldNames ? '' : 'name')
    ..e<$2.Encryption_Type>(3, _omitFieldNames ? '' : 'encryption', $pb.PbFieldType.OE, defaultOrMaker: $2.Encryption_Type.NONE, valueOf: $2.Encryption_Type.valueOf, enumValues: $2.Encryption_Type.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  PublishDataTrackRequest clone() => PublishDataTrackRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PublishDataTrackRequest copyWith(void Function(PublishDataTrackRequest) updates) => super.copyWith((message) => updates(message as PublishDataTrackRequest)) as PublishDataTrackRequest;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static PublishDataTrackRequest create() => PublishDataTrackRequest._();
  PublishDataTrackRequest createEmptyInstance() => create();
  static $pb.PbList<PublishDataTrackRequest> createRepeated() => $pb.PbList<PublishDataTrackRequest>();
  @$core.pragma('dart2js:noInline')
  static PublishDataTrackRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PublishDataTrackRequest>(create);
  ...
  @$pb.TagNumber(3)
  $2.Encryption_Type get encryption => $_getN(2);
  @$pb.TagNumber(3)
  set encryption($2.Encryption_Type v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasEncryption() => $_has(2);
  @$pb.TagNumber(3)
  void clearEncryption() => clearField(3);
}

class PublishDataTrackResponse extends $pb.GeneratedMessage {
  factory PublishDataTrackResponse({
    $2.DataTrackInfo? info,
  }) {
    final $result = create();
    if (info != null) {
      $result.info = info;
  ...
  PublishDataTrackResponse._() : super();
  factory PublishDataTrackResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory PublishDataTrackResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PublishDataTrackResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'livekit'), createEmptyInstance: create)
    ..aOM<$2.DataTrackInfo>(1, _omitFieldNames ? '' : 'info', subBuilder: $2.DataTrackInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  PublishDataTrackResponse clone() => PublishDataTrackResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PublishDataTrackResponse copyWith(void Function(PublishDataTrackResponse) updates) => super.copyWith((message) => updates(message as PublishDataTrackResponse)) as PublishDataTrackResponse;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static PublishDataTrackResponse create() => PublishDataTrackResponse._();
  PublishDataTrackResponse createEmptyInstance() => create();
  static $pb.PbList<PublishDataTrackResponse> createRepeated() => $pb.PbList<PublishDataTrackResponse>();
  @$core.pragma('dart2js:noInline')
  static PublishDataTrackResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PublishDataTrackResponse>(create);
  static PublishDataTrackResponse? _defaultInstance;

  /// Information about the published track.
  @$pb.TagNumber(1)
  $2.DataTrackInfo get info => $_getN(0);
  @$pb.TagNumber(1)
  set info($2.DataTrackInfo v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasInfo() => $_has(0);
  @$pb.TagNumber(1)
  void clearInfo() => clearField(1);
  @$pb.TagNumber(1)
  $2.DataTrackInfo ensureInfo() => $_ensure(0);
}

class UnpublishDataTrackRequest extends $pb.GeneratedMessage {
  factory UnpublishDataTrackRequest({
    $core.int? pubHandle,
  }) {
    final $result = create();
    if (pubHandle != null) {
  ...
  UnpublishDataTrackRequest._() : super();
  factory UnpublishDataTrackRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UnpublishDataTrackRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UnpublishDataTrackRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'livekit'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'pubHandle', $pb.PbFieldType.OU3)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  UnpublishDataTrackRequest clone() => UnpublishDataTrackRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UnpublishDataTrackRequest copyWith(void Function(UnpublishDataTrackRequest) updates) => super.copyWith((message) => updates(message as UnpublishDataTrackRequest)) as UnpublishDataTrackRequest;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static UnpublishDataTrackRequest create() => UnpublishDataTrackRequest._();
  UnpublishDataTrackRequest createEmptyInstance() => create();
  static $pb.PbList<UnpublishDataTrackRequest> createRepeated() => $pb.PbList<UnpublishDataTrackRequest>();
  @$core.pragma('dart2js:noInline')
  static UnpublishDataTrackRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UnpublishDataTrackRequest>(create);
...
class UnpublishDataTrackResponse extends $pb.GeneratedMessage {
  factory UnpublishDataTrackResponse({
    $2.DataTrackInfo? info,
  }) {
    final $result = create();
    if (info != null) {
  ...
  UnpublishDataTrackResponse._() : super();
  factory UnpublishDataTrackResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UnpublishDataTrackResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UnpublishDataTrackResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'livekit'), createEmptyInstance: create)
    ..aOM<$2.DataTrackInfo>(1, _omitFieldNames ? '' : 'info', subBuilder: $2.DataTrackInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  UnpublishDataTrackResponse clone() => UnpublishDataTrackResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UnpublishDataTrackResponse copyWith(void Function(UnpublishDataTrackResponse) updates) => super.copyWith((message) => updates(message as UnpublishDataTrackResponse)) as UnpublishDataTrackResponse;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static UnpublishDataTrackResponse create() => UnpublishDataTrackResponse._();
  UnpublishDataTrackResponse createEmptyInstance() => create();
  static $pb.PbList<UnpublishDataTrackResponse> createRepeated() => $pb.PbList<UnpublishDataTrackResponse>();
  @$core.pragma('dart2js:noInline')
  static UnpublishDataTrackResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UnpublishDataTrackResponse>(create);
...
class DataTrackSubscriberHandles_PublishedDataTrack extends $pb.GeneratedMessage {
  factory DataTrackSubscriberHandles_PublishedDataTrack({
    ...
    if (publisherSid != null) {
      $result.publisherSid = publisherSid;
    }
    if (trackSid != null) {
  ...
  DataTrackSubscriberHandles_PublishedDataTrack._() : super();
  factory DataTrackSubscriberHandles_PublishedDataTrack.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory DataTrackSubscriberHandles_PublishedDataTrack.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DataTrackSubscriberHandles.PublishedDataTrack', package: const $pb.PackageName(_omitMessageNames ? '' : 'livekit'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'publisherIdentity')
    ..aOS(2, _omitFieldNames ? '' : 'publisherSid')
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  DataTrackSubscriberHandles_PublishedDataTrack clone() => DataTrackSubscriberHandles_PublishedDataTrack()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DataTrackSubscriberHandles_PublishedDataTrack copyWith(void Function(DataTrackSubscriberHandles_PublishedDataTrack) updates) => super.copyWith((message) => updates(message as DataTrackSubscriberHandles_PublishedDataTrack)) as DataTrackSubscriberHandles_PublishedDataTrack;
  ...
  static $pb.PbList<DataTrackSubscriberHandles_PublishedDataTrack> createRepeated() => $pb.PbList<DataTrackSubscriberHandles_PublishedDataTrack>();
  @$core.pragma('dart2js:noInline')
  static DataTrackSubscriberHandles_PublishedDataTrack getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<DataTrackSubscriberHandles_PublishedDataTrack>(create);
  static DataTrackSubscriberHandles_PublishedDataTrack? _defaultInstance;

  @$pb.TagNumber(1)
  $core.String get publisherIdentity => $_getSZ(0);
  @$pb.TagNumber(1)
  set publisherIdentity($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasPublisherIdentity() => $_has(0);
  @$pb.TagNumber(1)
  void clearPublisherIdentity() => clearField(1);

  @$pb.TagNumber(2)
  $core.String get publisherSid => $_getSZ(1);
  @$pb.TagNumber(2)
  set publisherSid($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasPublisherSid() => $_has(1);
  @$pb.TagNumber(2)
  void clearPublisherSid() => clearField(2);
...
class DataTrackSubscriberHandles extends $pb.GeneratedMessage {
  factory DataTrackSubscriberHandles({
    $core.Map<$core.int, DataTrackSubscriberHandles_PublishedDataTrack>? subHandles,
  }) {
    final $result = create();
    if (subHandles != null) {
      $result.subHandles.addAll(subHandles);
    }
    return $result;
  }
  DataTrackSubscriberHandles._() : super();
  factory DataTrackSubscriberHandles.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory DataTrackSubscriberHandles.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DataTrackSubscriberHandles', package: const $pb.PackageName(_omitMessageNames ? '' : 'livekit'), createEmptyInstance: create)
    ..m<$core.int, DataTrackSubscriberHandles_PublishedDataTrack>(1, _omitFieldNames ? '' : 'subHandles', entryClassName: 'DataTrackSubscriberHandles.SubHandlesEntry', keyFieldType: $pb.PbFieldType.OU3, valueFieldType: $pb.PbFieldType.OM, valueCreator: DataTrackSubscriberHandles_PublishedDataTrack.create, valueDefaultOrMaker: DataTrackSubscriberHandles_PublishedDataTrack.getDefault, packageName: const $pb.PackageName('livekit'))
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  DataTrackSubscriberHandles clone() => DataTrackSubscriberHandles()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DataTrackSubscriberHandles copyWith(void Function(DataTrackSubscriberHandles) updates) => super.copyWith((message) => updates(message as DataTrackSubscriberHandles)) as DataTrackSubscriberHandles;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static DataTrackSubscriberHandles create() => DataTrackSubscriberHandles._();
  DataTrackSubscriberHandles createEmptyInstance() => create();
  static $pb.PbList<DataTrackSubscriberHandles> createRepeated() => $pb.PbList<DataTrackSubscriberHandles>();
  @$core.pragma('dart2js:noInline')
  static DataTrackSubscriberHandles getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<DataTrackSubscriberHandles>(create);
  ...
  @$pb.TagNumber(1)
  $core.Map<$core.int, DataTrackSubscriberHandles_PublishedDataTrack> get subHandles => $_getMap(0);
}
...
class TrickleRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set final_3($core.bool v) { $_setBool(2, v); }
  @$pb.TagNumber(3)
...
class JoinResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'JoinResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'livekit'), createEmptyInstance: create)
    ...
    ..aOM<$2.ParticipantInfo>(2, _omitFieldNames ? '' : 'participant', subBuilder: $2.ParticipantInfo.create)
    ..pc<$2.ParticipantInfo>(3, _omitFieldNames ? '' : 'otherParticipants', $pb.PbFieldType.PM, subBuilder: $2.ParticipantInfo.create)
    ...
    ..aOM<$2.ClientConfiguration>(8, _omitFieldNames ? '' : 'clientConfiguration', subBuilder: $2.ClientConfiguration.create)
    ...
    ..aOM<$2.ServerInfo>(12, _omitFieldNames ? '' : 'serverInfo', subBuilder: $2.ServerInfo.create)
    ..a<$core.List<$core.int>>(13, _omitFieldNames ? '' : 'sifTrailer', $pb.PbFieldType.OY)
    ..pc<$2.Codec>(14, _omitFieldNames ? '' : 'enabledPublishCodecs', $pb.PbFieldType.PM, subBuilder: $2.Codec.create)
  ...
  @$pb.TagNumber(1)
  set room($2.Room v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set participant($2.ParticipantInfo v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(8)
  set clientConfiguration($2.ClientConfiguration v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(12)
  set serverInfo($2.ServerInfo v) { setField(12, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(15)
  set fastPublish($core.bool v) { $_setBool(14, v); }
  @$pb.TagNumber(15)
...
class ReconnectResponse extends $pb.GeneratedMessage {
  factory ReconnectResponse({
    ...
    if (lastMessageSeq != null) {
      $result.lastMessageSeq = lastMessageSeq;
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReconnectResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'livekit'), createEmptyInstance: create)
    ...
    ..aOM<$2.ClientConfiguration>(2, _omitFieldNames ? '' : 'clientConfiguration', subBuilder: $2.ClientConfiguration.create)
    ..aOM<$2.ServerInfo>(3, _omitFieldNames ? '' : 'serverInfo', subBuilder: $2.ServerInfo.create)
    ..a<$core.int>(4, _omitFieldNames ? '' : 'lastMessageSeq', $pb.PbFieldType.OU3)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set clientConfiguration($2.ClientConfiguration v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(4)
  set lastMessageSeq($core.int v) { $_setUnsignedInt32(3, v); }
  @$pb.TagNumber(4)
  $core.bool hasLastMessageSeq() => $_has(3);
  @$pb.TagNumber(4)
  void clearLastMessageSeq() => clearField(4);
}
...
class TrackPublishedResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TrackPublishedResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'livekit'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'cid')
    ..aOM<$2.TrackInfo>(2, _omitFieldNames ? '' : 'track', subBuilder: $2.TrackInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set track($2.TrackInfo v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class SessionDescription extends $pb.GeneratedMessage {
  factory SessionDescription({
    ...
    $core.String? sdp,
    $core.int? id,
    $core.Map<$core.String, $core.String>? midToTrackId,
  }) {
    final $result = create();
    if (type != null) {
      $result.type = type;
    ...
    if (midToTrackId != null) {
      $result.midToTrackId.addAll(midToTrackId);
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SessionDescription', package: const $pb.PackageName(_omitMessageNames ? '' : 'livekit'), createEmptyInstance: create)
    ...
    ..m<$core.String, $core.String>(4, _omitFieldNames ? '' : 'midToTrackId', entryClassName: 'SessionDescription.MidToTrackIdEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('livekit'))
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $core.Map<$core.String, $core.String> get midToTrackId => $_getMap(3);
}
...
class UpdateSubscription extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateSubscription', package: const $pb.PackageName(_omitMessageNames ? '' : 'livekit'), createEmptyInstance: create)
    ...
    ..pc<$2.ParticipantTracks>(3, _omitFieldNames ? '' : 'participantTracks', $pb.PbFieldType.PM, subBuilder: $2.ParticipantTracks.create)
    ..hasRequiredFields = false
  ;
...
class UpdateDataSubscription_Update extends $pb.GeneratedMessage {
  factory UpdateDataSubscription_Update({
    $core.String? trackSid,
    $core.bool? subscribe,
    $2.DataTrackSubscriptionOptions? options,
  }) {
    final $result = create();
    if (trackSid != null) {
      $result.trackSid = trackSid;
  ...
  UpdateDataSubscription_Update._() : super();
  factory UpdateDataSubscription_Update.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UpdateDataSubscription_Update.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateDataSubscription.Update', package: const $pb.PackageName(_omitMessageNames ? '' : 'livekit'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'trackSid')
    ..aOB(2, _omitFieldNames ? '' : 'subscribe')
    ..aOM<$2.DataTrackSubscriptionOptions>(3, _omitFieldNames ? '' : 'options', subBuilder: $2.DataTrackSubscriptionOptions.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  UpdateDataSubscription_Update clone() => UpdateDataSubscription_Update()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UpdateDataSubscription_Update copyWith(void Function(UpdateDataSubscription_Update) updates) => super.copyWith((message) => updates(message as UpdateDataSubscription_Update)) as UpdateDataSubscription_Update;
  ...
  static $pb.PbList<UpdateDataSubscription_Update> createRepeated() => $pb.PbList<UpdateDataSubscription_Update>();
  @$core.pragma('dart2js:noInline')
  static UpdateDataSubscription_Update getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UpdateDataSubscription_Update>(create);
  ...
  @$pb.TagNumber(3)
  $2.DataTrackSubscriptionOptions get options => $_getN(2);
  @$pb.TagNumber(3)
  set options($2.DataTrackSubscriptionOptions v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasOptions() => $_has(2);
  @$pb.TagNumber(3)
  void clearOptions() => clearField(3);
  @$pb.TagNumber(3)
  $2.DataTrackSubscriptionOptions ensureOptions() => $_ensure(2);
}

class UpdateDataSubscription extends $pb.GeneratedMessage {
  factory UpdateDataSubscription({
    $core.Iterable<UpdateDataSubscription_Update>? updates,
  }) {
    final $result = create();
    if (updates != null) {
  ...
  UpdateDataSubscription._() : super();
  factory UpdateDataSubscription.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UpdateDataSubscription.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateDataSubscription', package: const $pb.PackageName(_omitMessageNames ? '' : 'livekit'), createEmptyInstance: create)
    ..pc<UpdateDataSubscription_Update>(1, _omitFieldNames ? '' : 'updates', $pb.PbFieldType.PM, subBuilder: UpdateDataSubscription_Update.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  UpdateDataSubscription clone() => UpdateDataSubscription()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UpdateDataSubscription copyWith(void Function(UpdateDataSubscription) updates) => super.copyWith((message) => updates(message as UpdateDataSubscription)) as UpdateDataSubscription;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static UpdateDataSubscription create() => UpdateDataSubscription._();
  UpdateDataSubscription createEmptyInstance() => create();
  static $pb.PbList<UpdateDataSubscription> createRepeated() => $pb.PbList<UpdateDataSubscription>();
  @$core.pragma('dart2js:noInline')
  static UpdateDataSubscription getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UpdateDataSubscription>(create);
  static UpdateDataSubscription? _defaultInstance;

  @$pb.TagNumber(1)
  $core.List<UpdateDataSubscription_Update> get updates => $_getList(0);
}
...
class UpdateTrackSettings extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateTrackSettings', package: const $pb.PackageName(_omitMessageNames ? '' : 'livekit'), createEmptyInstance: create)
    ...
    ..e<$2.VideoQuality>(4, _omitFieldNames ? '' : 'quality', $pb.PbFieldType.OE, defaultOrMaker: $2.VideoQuality.LOW, valueOf: $2.VideoQuality.valueOf, enumValues: $2.VideoQuality.values)
  ...
  @$pb.TagNumber(4)
  set quality($2.VideoQuality v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class UpdateLocalAudioTrack extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateLocalAudioTrack', package: const $pb.PackageName(_omitMessageNames ? '' : 'livekit'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'trackSid')
    ..pc<$2.AudioTrackFeature>(2, _omitFieldNames ? '' : 'features', $pb.PbFieldType.KE, valueOf: $2.AudioTrackFeature.valueOf, enumValues: $2.AudioTrackFeature.values, defaultEnumValue: $2.AudioTrackFeature.TF_STEREO)
    ..hasRequiredFields = false
  ;
...
class LeaveRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LeaveRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'livekit'), createEmptyInstance: create)
    ...
    ..e<$2.DisconnectReason>(2, _omitFieldNames ? '' : 'reason', $pb.PbFieldType.OE, defaultOrMaker: $2.DisconnectReason.UNKNOWN_REASON, valueOf: $2.DisconnectReason.valueOf, enumValues: $2.DisconnectReason.values)
  ...
  @$pb.TagNumber(2)
  set reason($2.DisconnectReason v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(4)
  void clearRegions() => clearField(4);
  @$pb.TagNumber(4)
...
class UpdateVideoLayers extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateVideoLayers', package: const $pb.PackageName(_omitMessageNames ? '' : 'livekit'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'trackSid')
    ..pc<$2.VideoLayer>(2, _omitFieldNames ? '' : 'layers', $pb.PbFieldType.PM, subBuilder: $2.VideoLayer.create)
    ..hasRequiredFields = false
  ;
...
class UpdateParticipantMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateParticipantMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'livekit'), createEmptyInstance: create)
    ...
    ..aOS(2, _omitFieldNames ? '' : 'name')
    ..m<$core.String, $core.String>(3, _omitFieldNames ? '' : 'attributes', entryClassName: 'UpdateParticipantMetadata.AttributesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('livekit'))
  ...
  @$pb.TagNumber(4)
  set requestId($core.int v) { $_setUnsignedInt32(3, v); }
  @$pb.TagNumber(4)
...
class SpeakersChanged extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SpeakersChanged', package: const $pb.PackageName(_omitMessageNames ? '' : 'livekit'), createEmptyInstance: create)
    ..pc<$2.SpeakerInfo>(1, _omitFieldNames ? '' : 'speakers', $pb.PbFieldType.PM, subBuilder: $2.SpeakerInfo.create)
    ..hasRequiredFields = false
  ;
...
class ConnectionQualityInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ConnectionQualityInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'livekit'), createEmptyInstance: create)
    ...
    ..e<$2.ConnectionQuality>(2, _omitFieldNames ? '' : 'quality', $pb.PbFieldType.OE, defaultOrMaker: $2.ConnectionQuality.POOR, valueOf: $2.ConnectionQuality.valueOf, enumValues: $2.ConnectionQuality.values)
  ...
  @$pb.TagNumber(2)
  set quality($2.ConnectionQuality v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class SubscribedQuality extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SubscribedQuality', package: const $pb.PackageName(_omitMessageNames ? '' : 'livekit'), createEmptyInstance: create)
    ..e<$2.VideoQuality>(1, _omitFieldNames ? '' : 'quality', $pb.PbFieldType.OE, defaultOrMaker: $2.VideoQuality.LOW, valueOf: $2.VideoQuality.valueOf, enumValues: $2.VideoQuality.values)
  ...
  @$pb.TagNumber(1)
  set quality($2.VideoQuality v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class SubscribedAudioCodecUpdate extends $pb.GeneratedMessage {
  factory SubscribedAudioCodecUpdate({
    $core.String? trackSid,
    $core.Iterable<$2.SubscribedAudioCodec>? subscribedAudioCodecs,
  }) {
    final $result = create();
    if (trackSid != null) {
      $result.trackSid = trackSid;
  ...
  SubscribedAudioCodecUpdate._() : super();
  factory SubscribedAudioCodecUpdate.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SubscribedAudioCodecUpdate.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SubscribedAudioCodecUpdate', package: const $pb.PackageName(_omitMessageNames ? '' : 'livekit'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'trackSid')
    ..pc<$2.SubscribedAudioCodec>(2, _omitFieldNames ? '' : 'subscribedAudioCodecs', $pb.PbFieldType.PM, subBuilder: $2.SubscribedAudioCodec.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  SubscribedAudioCodecUpdate clone() => SubscribedAudioCodecUpdate()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SubscribedAudioCodecUpdate copyWith(void Function(SubscribedAudioCodecUpdate) updates) => super.copyWith((message) => updates(message as SubscribedAudioCodecUpdate)) as SubscribedAudioCodecUpdate;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static SubscribedAudioCodecUpdate create() => SubscribedAudioCodecUpdate._();
  SubscribedAudioCodecUpdate createEmptyInstance() => create();
  static $pb.PbList<SubscribedAudioCodecUpdate> createRepeated() => $pb.PbList<SubscribedAudioCodecUpdate>();
  @$core.pragma('dart2js:noInline')
  static SubscribedAudioCodecUpdate getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SubscribedAudioCodecUpdate>(create);
  ...
  @$pb.TagNumber(2)
  $core.List<$2.SubscribedAudioCodec> get subscribedAudioCodecs => $_getList(1);
}
...
class RoomMovedResponse extends $pb.GeneratedMessage {
  ...
  RoomMovedResponse._() : super();
  factory RoomMovedResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory RoomMovedResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RoomMovedResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'livekit'), createEmptyInstance: create)
    ..aOM<$2.Room>(1, _omitFieldNames ? '' : 'room', subBuilder: $2.Room.create)
    ..aOS(2, _omitFieldNames ? '' : 'token')
    ..aOM<$2.ParticipantInfo>(3, _omitFieldNames ? '' : 'participant', subBuilder: $2.ParticipantInfo.create)
    ..pc<$2.ParticipantInfo>(4, _omitFieldNames ? '' : 'otherParticipants', $pb.PbFieldType.PM, subBuilder: $2.ParticipantInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RoomMovedResponse copyWith(void Function(RoomMovedResponse) updates) => super.copyWith((message) => updates(message as RoomMovedResponse)) as RoomMovedResponse;
  ...
  static $pb.PbList<RoomMovedResponse> createRepeated() => $pb.PbList<RoomMovedResponse>();
  @$core.pragma('dart2js:noInline')
  static RoomMovedResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<RoomMovedResponse>(create);
  ...
  @$pb.TagNumber(4)
  $core.List<$2.ParticipantInfo> get otherParticipants => $_getList(3);
}
...
class SyncState extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SyncState', package: const $pb.PackageName(_omitMessageNames ? '' : 'livekit'), createEmptyInstance: create)
    ...
    ..pc<DataChannelReceiveState>(7, _omitFieldNames ? '' : 'datachannelReceiveStates', $pb.PbFieldType.PM, subBuilder: DataChannelReceiveState.create)
    ..pc<PublishDataTrackResponse>(8, _omitFieldNames ? '' : 'publishDataTracks', $pb.PbFieldType.PM, subBuilder: PublishDataTrackResponse.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(6)
  $core.List<$core.String> get trackSidsDisabled => $_getList(5);

  @$pb.TagNumber(7)
  $core.List<DataChannelReceiveState> get datachannelReceiveStates => $_getList(6);

  @$pb.TagNumber(8)
  $core.List<PublishDataTrackResponse> get publishDataTracks => $_getList(7);
}
...
class DataChannelReceiveState extends $pb.GeneratedMessage {
  ...
  DataChannelReceiveState._() : super();
  factory DataChannelReceiveState.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory DataChannelReceiveState.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DataChannelReceiveState', package: const $pb.PackageName(_omitMessageNames ? '' : 'livekit'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  DataChannelReceiveState clone() => DataChannelReceiveState()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DataChannelReceiveState copyWith(void Function(DataChannelReceiveState) updates) => super.copyWith((message) => updates(message as DataChannelReceiveState)) as DataChannelReceiveState;
  ...
  static $pb.PbList<DataChannelReceiveState> createRepeated() => $pb.PbList<DataChannelReceiveState>();
  @$core.pragma('dart2js:noInline')
  static DataChannelReceiveState getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<DataChannelReceiveState>(create);
  static DataChannelReceiveState? _defaultInstance;

  @$pb.TagNumber(1)
  $core.String get publisherSid => $_getSZ(0);
  @$pb.TagNumber(1)
  set publisherSid($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasPublisherSid() => $_has(0);
  @$pb.TagNumber(1)
  void clearPublisherSid() => clearField(1);

  @$pb.TagNumber(2)
  $core.int get lastSeq => $_getIZ(1);
  @$pb.TagNumber(2)
  set lastSeq($core.int v) { $_setUnsignedInt32(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasLastSeq() => $_has(1);
  @$pb.TagNumber(2)
  void clearLastSeq() => clearField(2);
}
...
class SimulateScenario extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(7)
  void clearDisconnectSignalOnResume() => clearField(7);
  ...
  @$pb.TagNumber(9)
  set leaveRequestFullReconnect($core.bool v) { $_setBool(8, v); }
  @$pb.TagNumber(9)
...
class SubscriptionResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SubscriptionResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'livekit'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'trackSid')
    ..e<$2.SubscriptionError>(2, _omitFieldNames ? '' : 'err', $pb.PbFieldType.OE, defaultOrMaker: $2.SubscriptionError.SE_UNKNOWN, valueOf: $2.SubscriptionError.valueOf, enumValues: $2.SubscriptionError.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set err($2.SubscriptionError v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class RequestResponse extends $pb.GeneratedMessage {
  factory RequestResponse({
    ...
    if (publishDataTrack != null) {
      $result.publishDataTrack = publishDataTrack;
    }
  ...
  static const $core.Map<$core.int, RequestResponse_Request> _RequestResponse_RequestByTag = {
    ...
    7 : RequestResponse_Request.updateMetadata,
    8 : RequestResponse_Request.updateAudioTrack,
    9 : RequestResponse_Request.updateVideoTrack,
    10 : RequestResponse_Request.publishDataTrack,
    11 : RequestResponse_Request.unpublishDataTrack,
    0 : RequestResponse_Request.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RequestResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'livekit'), createEmptyInstance: create)
    ..oo(0, [4, 5, 6, 7, 8, 9, 10, 11])
    ..a<$core.int>(1, _omitFieldNames ? '' : 'requestId', $pb.PbFieldType.OU3)
    ..e<RequestResponse_Reason>(2, _omitFieldNames ? '' : 'reason', $pb.PbFieldType.OE, defaultOrMaker: RequestResponse_Reason.OK, valueOf: RequestResponse_Reason.valueOf, enumValues: RequestResponse_Reason.values)
    ...
    ..aOM<UpdateParticipantMetadata>(7, _omitFieldNames ? '' : 'updateMetadata', subBuilder: UpdateParticipantMetadata.create)
    ...
    ..aOM<PublishDataTrackRequest>(10, _omitFieldNames ? '' : 'publishDataTrack', subBuilder: PublishDataTrackRequest.create)
    ..aOM<UnpublishDataTrackRequest>(11, _omitFieldNames ? '' : 'unpublishDataTrack', subBuilder: UnpublishDataTrackRequest.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set reason(RequestResponse_Reason v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasReason() => $_has(1);
  @$pb.TagNumber(2)
  void clearReason() => clearField(2);
  ...
  @$pb.TagNumber(5)
  AddTrackRequest get addTrack => $_getN(4);
  @$pb.TagNumber(5)
  set addTrack(AddTrackRequest v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasAddTrack() => $_has(4);
  @$pb.TagNumber(5)
  void clearAddTrack() => clearField(5);
  @$pb.TagNumber(5)
  AddTrackRequest ensureAddTrack() => $_ensure(4);

  @$pb.TagNumber(6)
  MuteTrackRequest get mute => $_getN(5);
  @$pb.TagNumber(6)
  set mute(MuteTrackRequest v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasMute() => $_has(5);
  @$pb.TagNumber(6)
  void clearMute() => clearField(6);
  @$pb.TagNumber(6)
  MuteTrackRequest ensureMute() => $_ensure(5);

  @$pb.TagNumber(7)
  UpdateParticipantMetadata get updateMetadata => $_getN(6);
  @$pb.TagNumber(7)
  set updateMetadata(UpdateParticipantMetadata v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasUpdateMetadata() => $_has(6);
  @$pb.TagNumber(7)
  void clearUpdateMetadata() => clearField(7);
  @$pb.TagNumber(7)
  UpdateParticipantMetadata ensureUpdateMetadata() => $_ensure(6);

  @$pb.TagNumber(8)
  UpdateLocalAudioTrack get updateAudioTrack => $_getN(7);
  @$pb.TagNumber(8)
  set updateAudioTrack(UpdateLocalAudioTrack v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasUpdateAudioTrack() => $_has(7);
  @$pb.TagNumber(8)
  void clearUpdateAudioTrack() => clearField(8);
  @$pb.TagNumber(8)
  UpdateLocalAudioTrack ensureUpdateAudioTrack() => $_ensure(7);

  @$pb.TagNumber(9)
  UpdateLocalVideoTrack get updateVideoTrack => $_getN(8);
  @$pb.TagNumber(9)
  set updateVideoTrack(UpdateLocalVideoTrack v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasUpdateVideoTrack() => $_has(8);
  @$pb.TagNumber(9)
  void clearUpdateVideoTrack() => clearField(9);
  @$pb.TagNumber(9)
  UpdateLocalVideoTrack ensureUpdateVideoTrack() => $_ensure(8);

  @$pb.TagNumber(10)
  PublishDataTrackRequest get publishDataTrack => $_getN(9);
  @$pb.TagNumber(10)
  set publishDataTrack(PublishDataTrackRequest v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasPublishDataTrack() => $_has(9);
  @$pb.TagNumber(10)
  void clearPublishDataTrack() => clearField(10);
  @$pb.TagNumber(10)
  PublishDataTrackRequest ensurePublishDataTrack() => $_ensure(9);

  @$pb.TagNumber(11)
  UnpublishDataTrackRequest get unpublishDataTrack => $_getN(10);
  @$pb.TagNumber(11)
  set unpublishDataTrack(UnpublishDataTrackRequest v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasUnpublishDataTrack() => $_has(10);
  @$pb.TagNumber(11)
  void clearUnpublishDataTrack() => clearField(11);
  @$pb.TagNumber(11)
  UnpublishDataTrackRequest ensureUnpublishDataTrack() => $_ensure(10);
}
...
class TrackSubscribed extends $pb.GeneratedMessage {
  ...
  factory TrackSubscribed.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory TrackSubscribed.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TrackSubscribed', package: const $pb.PackageName(_omitMessageNames ? '' : 'livekit'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'trackSid')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TrackSubscribed copyWith(void Function(TrackSubscribed) updates) => super.copyWith((message) => updates(message as TrackSubscribed)) as TrackSubscribed;
  ...
  static $pb.PbList<TrackSubscribed> createRepeated() => $pb.PbList<TrackSubscribed>();
  @$core.pragma('dart2js:noInline')
  static TrackSubscribed getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<TrackSubscribed>(create);
...
class ConnectionSettings extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ConnectionSettings', package: const $pb.PackageName(_omitMessageNames ? '' : 'livekit'), createEmptyInstance: create)
  ...
  @$pb.TagNumber(1)
  $core.bool get autoSubscribe => $_getBF(0);
  @$pb.TagNumber(1)
  set autoSubscribe($core.bool v) { $_setBool(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasAutoSubscribe() => $_has(0);
  @$pb.TagNumber(1)
  void clearAutoSubscribe() => clearField(1);

  @$pb.TagNumber(2)
  $core.bool get adaptiveStream => $_getBF(1);
  @$pb.TagNumber(2)
  set adaptiveStream($core.bool v) { $_setBool(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasAdaptiveStream() => $_has(1);
  @$pb.TagNumber(2)
  void clearAdaptiveStream() => clearField(2);

  @$pb.TagNumber(3)
  $core.bool get subscriberAllowPause => $_getBF(2);
  @$pb.TagNumber(3)
  set subscriberAllowPause($core.bool v) { $_setBool(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasSubscriberAllowPause() => $_has(2);
  @$pb.TagNumber(3)
  void clearSubscriberAllowPause() => clearField(3);

  @$pb.TagNumber(4)
  $core.bool get disableIceLite => $_getBF(3);
  @$pb.TagNumber(4)
  set disableIceLite($core.bool v) { $_setBool(3, v); }
  @$pb.TagNumber(4)
  $core.bool hasDisableIceLite() => $_has(3);
  @$pb.TagNumber(4)
  void clearDisableIceLite() => clearField(4);
}
...
class JoinRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'JoinRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'livekit'), createEmptyInstance: create)
    ..aOM<$2.ClientInfo>(1, _omitFieldNames ? '' : 'clientInfo', subBuilder: $2.ClientInfo.create)
    ...
    ..m<$core.String, $core.String>(4, _omitFieldNames ? '' : 'participantAttributes', entryClassName: 'JoinRequest.ParticipantAttributesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('livekit'))
    ..pc<AddTrackRequest>(5, _omitFieldNames ? '' : 'addTrackRequests', $pb.PbFieldType.PM, subBuilder: AddTrackRequest.create)
    ...
    ..e<$2.ReconnectReason>(8, _omitFieldNames ? '' : 'reconnectReason', $pb.PbFieldType.OE, defaultOrMaker: $2.ReconnectReason.RR_UNKNOWN, valueOf: $2.ReconnectReason.valueOf, enumValues: $2.ReconnectReason.values)
  ...
  @$pb.TagNumber(1)
  $2.ClientInfo get clientInfo => $_getN(0);
  @$pb.TagNumber(1)
  set clientInfo($2.ClientInfo v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasClientInfo() => $_has(0);
  @$pb.TagNumber(1)
  void clearClientInfo() => clearField(1);
  @$pb.TagNumber(1)
  $2.ClientInfo ensureClientInfo() => $_ensure(0);

  @$pb.TagNumber(2)
  ConnectionSettings get connectionSettings => $_getN(1);
  @$pb.TagNumber(2)
  set connectionSettings(ConnectionSettings v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasConnectionSettings() => $_has(1);
  @$pb.TagNumber(2)
  void clearConnectionSettings() => clearField(2);
  @$pb.TagNumber(2)
  ConnectionSettings ensureConnectionSettings() => $_ensure(1);
  ...
  @$pb.TagNumber(4)
  $core.Map<$core.String, $core.String> get participantAttributes => $_getMap(3);

  @$pb.TagNumber(5)
  $core.List<AddTrackRequest> get addTrackRequests => $_getList(4);

  @$pb.TagNumber(6)
  SessionDescription get publisherOffer => $_getN(5);
  @$pb.TagNumber(6)
  set publisherOffer(SessionDescription v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasPublisherOffer() => $_has(5);
  @$pb.TagNumber(6)
  void clearPublisherOffer() => clearField(6);
  @$pb.TagNumber(6)
  SessionDescription ensurePublisherOffer() => $_ensure(5);

  @$pb.TagNumber(7)
  $core.bool get reconnect => $_getBF(6);
  @$pb.TagNumber(7)
  set reconnect($core.bool v) { $_setBool(6, v); }
  @$pb.TagNumber(7)
  $core.bool hasReconnect() => $_has(6);
  @$pb.TagNumber(7)
  void clearReconnect() => clearField(7);

  @$pb.TagNumber(8)
  $2.ReconnectReason get reconnectReason => $_getN(7);
  @$pb.TagNumber(8)
  set reconnectReason($2.ReconnectReason v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasReconnectReason() => $_has(7);
  @$pb.TagNumber(8)
  void clearReconnectReason() => clearField(8);

  @$pb.TagNumber(9)
  $core.String get participantSid => $_getSZ(8);
  @$pb.TagNumber(9)
  set participantSid($core.String v) { $_setString(8, v); }
  @$pb.TagNumber(9)
  $core.bool hasParticipantSid() => $_has(8);
  @$pb.TagNumber(9)
  void clearParticipantSid() => clearField(9);

  @$pb.TagNumber(10)
  SyncState get syncState => $_getN(9);
  @$pb.TagNumber(10)
  set syncState(SyncState v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasSyncState() => $_has(9);
  @$pb.TagNumber(10)
  void clearSyncState() => clearField(10);
  @$pb.TagNumber(10)
  SyncState ensureSyncState() => $_ensure(9);
}

class WrappedJoinRequest extends $pb.GeneratedMessage {
  factory WrappedJoinRequest({
    WrappedJoinRequest_Compression? compression,
    $core.List<$core.int>? joinRequest,
  }) {
    final $result = create();
    if (compression != null) {
  ...
  WrappedJoinRequest._() : super();
  factory WrappedJoinRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory WrappedJoinRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'WrappedJoinRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'livekit'), createEmptyInstance: create)
    ..e<WrappedJoinRequest_Compression>(1, _omitFieldNames ? '' : 'compression', $pb.PbFieldType.OE, defaultOrMaker: WrappedJoinRequest_Compression.NONE, valueOf: WrappedJoinRequest_Compression.valueOf, enumValues: WrappedJoinRequest_Compression.values)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  WrappedJoinRequest clone() => WrappedJoinRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  WrappedJoinRequest copyWith(void Function(WrappedJoinRequest) updates) => super.copyWith((message) => updates(message as WrappedJoinRequest)) as WrappedJoinRequest;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static WrappedJoinRequest create() => WrappedJoinRequest._();
  WrappedJoinRequest createEmptyInstance() => create();
  static $pb.PbList<WrappedJoinRequest> createRepeated() => $pb.PbList<WrappedJoinRequest>();
  @$core.pragma('dart2js:noInline')
  static WrappedJoinRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<WrappedJoinRequest>(create);
  static WrappedJoinRequest? _defaultInstance;

  @$pb.TagNumber(1)
  WrappedJoinRequest_Compression get compression => $_getN(0);
  @$pb.TagNumber(1)
  set compression(WrappedJoinRequest_Compression v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  $core.List<$core.int> get joinRequest => $_getN(1);
  @$pb.TagNumber(2)
  set joinRequest($core.List<$core.int> v) { $_setBytes(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasJoinRequest() => $_has(1);
  @$pb.TagNumber(2)
  void clearJoinRequest() => clearField(2);
}

class MediaSectionsRequirement extends $pb.GeneratedMessage {
  factory MediaSectionsRequirement({
    $core.int? numAudios,
    $core.int? numVideos,
  }) {
    final $result = create();
    if (numAudios != null) {
      $result.numAudios = numAudios;
    }
    if (numVideos != null) {
      $result.numVideos = numVideos;
    }
    return $result;
  }
  MediaSectionsRequirement._() : super();
  factory MediaSectionsRequirement.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory MediaSectionsRequirement.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MediaSectionsRequirement', package: const $pb.PackageName(_omitMessageNames ? '' : 'livekit'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'numAudios', $pb.PbFieldType.OU3)
    ..a<$core.int>(2, _omitFieldNames ? '' : 'numVideos', $pb.PbFieldType.OU3)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  MediaSectionsRequirement clone() => MediaSectionsRequirement()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MediaSectionsRequirement copyWith(void Function(MediaSectionsRequirement) updates) => super.copyWith((message) => updates(message as MediaSectionsRequirement)) as MediaSectionsRequirement;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static MediaSectionsRequirement create() => MediaSectionsRequirement._();
  MediaSectionsRequirement createEmptyInstance() => create();
  static $pb.PbList<MediaSectionsRequirement> createRepeated() => $pb.PbList<MediaSectionsRequirement>();
  @$core.pragma('dart2js:noInline')
  static MediaSectionsRequirement getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<MediaSectionsRequirement>(create);
  static MediaSectionsRequirement? _defaultInstance;

  @$pb.TagNumber(1)
  $core.int get numAudios => $_getIZ(0);
  @$pb.TagNumber(1)
  set numAudios($core.int v) { $_setUnsignedInt32(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasNumAudios() => $_has(0);
  @$pb.TagNumber(1)
  void clearNumAudios() => clearField(1);

  @$pb.TagNumber(2)
  $core.int get numVideos => $_getIZ(1);
  @$pb.TagNumber(2)
  set numVideos($core.int v) { $_setUnsignedInt32(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasNumVideos() => $_has(1);
  @$pb.TagNumber(2)
  void clearNumVideos() => clearField(2);
}
