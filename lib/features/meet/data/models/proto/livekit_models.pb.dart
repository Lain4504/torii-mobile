...
class ParticipantInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<DataTrackInfo>(
        19, _omitFieldNames ? '' : 'dataTracks', $pb.PbFieldType.PM,
...
class DataTrackInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(3, _omitFieldNames ? '' : 'name')
    ..e<Encryption_Type>(
        4, _omitFieldNames ? '' : 'encryption', $pb.PbFieldType.OE,
        defaultOrMaker: Encryption_Type.NONE,
        valueOf: Encryption_Type.valueOf,
        enumValues: Encryption_Type.values)
    ..hasRequiredFields = false;
  ...
  static $pb.PbList<DataTrackInfo> createRepeated() =>
      $pb.PbList<DataTrackInfo>();
  @$core.pragma('dart2js:noInline')
...
class DataTrackExtensionParticipantSid extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'livekit'),
      createEmptyInstance: create)
    ..e<DataTrackExtensionID>(
        1, _omitFieldNames ? '' : 'id', $pb.PbFieldType.OE,
        defaultOrMaker: DataTrackExtensionID.DTEI_INVALID,
        valueOf: DataTrackExtensionID.valueOf,
        enumValues: DataTrackExtensionID.values)
    ..aOS(2, _omitFieldNames ? '' : 'participantSid')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  DataTrackExtensionParticipantSid clone() =>
      DataTrackExtensionParticipantSid()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<DataTrackExtensionParticipantSid> createRepeated() =>
      $pb.PbList<DataTrackExtensionParticipantSid>();
  @$core.pragma('dart2js:noInline')
...
class DataTrackSubscriptionOptions extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  DataTrackSubscriptionOptions clone() =>
      DataTrackSubscriptionOptions()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<DataTrackSubscriptionOptions> createRepeated() =>
      $pb.PbList<DataTrackSubscriptionOptions>();
  @$core.pragma('dart2js:noInline')
...
class FilterParams extends $pb.GeneratedMessage {
  ...
  static $pb.PbList<FilterParams> createRepeated() =>
      $pb.PbList<FilterParams>();
  @$core.pragma('dart2js:noInline')
...
class SubscribedAudioCodec extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  SubscribedAudioCodec clone() =>
      SubscribedAudioCodec()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<SubscribedAudioCodec> createRepeated() =>
      $pb.PbList<SubscribedAudioCodec>();
  @$core.pragma('dart2js:noInline')
