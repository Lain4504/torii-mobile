...
class GoFeatures extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<GoFeatures_StripEnumPrefix>(
        3, _omitFieldNames ? '' : 'stripEnumPrefix', $pb.PbFieldType.OE,
        defaultOrMaker:
            GoFeatures_StripEnumPrefix.STRIP_ENUM_PREFIX_UNSPECIFIED,
        valueOf: GoFeatures_StripEnumPrefix.valueOf,
