...
class Node extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<NodeType>(5, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE,
        defaultOrMaker: NodeType.SERVER,
        valueOf: NodeType.valueOf,
        enumValues: NodeType.values)
    ..e<NodeState>(6, _omitFieldNames ? '' : 'state', $pb.PbFieldType.OE,
        defaultOrMaker: NodeState.STARTING_UP,
        valueOf: NodeState.valueOf,
...
class NodeStats extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$fixnum.Int64>(
        ...
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$core.double>(
        12, _omitFieldNames ? '' : 'bytesInPerSec', $pb.PbFieldType.OF)
    ..a<$core.double>(
        13, _omitFieldNames ? '' : 'bytesOutPerSec', $pb.PbFieldType.OF)
    ..a<$core.double>(
        14, _omitFieldNames ? '' : 'packetsInPerSec', $pb.PbFieldType.OF)
    ..a<$core.double>(
        15, _omitFieldNames ? '' : 'packetsOutPerSec', $pb.PbFieldType.OF)
    ..a<$core.double>(
        16, _omitFieldNames ? '' : 'nackPerSec', $pb.PbFieldType.OF)
    ..a<$core.int>(17, _omitFieldNames ? '' : 'numCpus', $pb.PbFieldType.OU3)
    ..a<$core.double>(
        18, _omitFieldNames ? '' : 'loadAvgLast1min', $pb.PbFieldType.OF)
    ..a<$core.double>(
        19, _omitFieldNames ? '' : 'loadAvgLast5min', $pb.PbFieldType.OF)
    ..a<$core.double>(
        20, _omitFieldNames ? '' : 'loadAvgLast15min', $pb.PbFieldType.OF)
    ...
    ..a<$fixnum.Int64>(
        ...
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$core.double>(24, _omitFieldNames ? '' : 'retransmitBytesOutPerSec',
        $pb.PbFieldType.OF)
    ..a<$core.double>(25, _omitFieldNames ? '' : 'retransmitPacketsOutPerSec',
        $pb.PbFieldType.OF)
    ...
    ..a<$core.double>(
        27,
        _omitFieldNames ? '' : 'participantSignalConnectedPerSec',
        $pb.PbFieldType.OF)
    ..a<$core.int>(
        28, _omitFieldNames ? '' : 'sysPacketsOut', $pb.PbFieldType.OU3)
    ..a<$core.int>(
        29, _omitFieldNames ? '' : 'sysPacketsDropped', $pb.PbFieldType.OU3)
    ..a<$core.double>(
        30, _omitFieldNames ? '' : 'sysPacketsOutPerSec', $pb.PbFieldType.OF)
    ..a<$core.double>(31, _omitFieldNames ? '' : 'sysPacketsDroppedPerSec',
        $pb.PbFieldType.OF)
    ..a<$core.double>(32, _omitFieldNames ? '' : 'sysPacketsDroppedPctPerSec',
        $pb.PbFieldType.OF)
    ..a<$core.double>(
        33, _omitFieldNames ? '' : 'memoryLoad', $pb.PbFieldType.OF)
    ..a<$fixnum.Int64>(
    ...
    ..a<$fixnum.Int64>(
        ...
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$core.int>(36, _omitFieldNames ? '' : 'numTrackPublishAttempts',
        $pb.PbFieldType.O3)
    ..a<$core.double>(37, _omitFieldNames ? '' : 'trackPublishAttemptsPerSec',
        $pb.PbFieldType.OF)
    ..a<$core.int>(
        38, _omitFieldNames ? '' : 'numTrackPublishSuccess', $pb.PbFieldType.O3)
    ..a<$core.double>(39, _omitFieldNames ? '' : 'trackPublishSuccessPerSec',
        $pb.PbFieldType.OF)
    ..a<$core.int>(40, _omitFieldNames ? '' : 'numTrackSubscribeAttempts',
        $pb.PbFieldType.O3)
    ..a<$core.double>(41, _omitFieldNames ? '' : 'trackSubscribeAttemptsPerSec',
        $pb.PbFieldType.OF)
    ..a<$core.int>(42, _omitFieldNames ? '' : 'numTrackSubscribeSuccess',
        $pb.PbFieldType.O3)
    ..a<$core.double>(43, _omitFieldNames ? '' : 'trackSubscribeSuccessPerSec',
        $pb.PbFieldType.OF)
    ...
    ..a<$core.double>(
        45,
        _omitFieldNames ? '' : 'participantRtcConnectedPerSec',
        $pb.PbFieldType.OF)
    ..a<$fixnum.Int64>(
        46, _omitFieldNames ? '' : 'participantRtcInit', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$core.double>(47, _omitFieldNames ? '' : 'participantRtcInitPerSec',
        $pb.PbFieldType.OF)
    ..a<$core.int>(
        48, _omitFieldNames ? '' : 'forwardLatency', $pb.PbFieldType.OU3)
    ..a<$core.int>(
        49, _omitFieldNames ? '' : 'forwardJitter', $pb.PbFieldType.OU3)
    ..pc<NodeStatsRate>(50, _omitFieldNames ? '' : 'rates', $pb.PbFieldType.PM,
        subBuilder: NodeStatsRate.create)
    ..a<$core.int>(
        51, _omitFieldNames ? '' : 'numTrackPublishCancels', $pb.PbFieldType.O3)
    ..a<$core.int>(52, _omitFieldNames ? '' : 'numTrackSubscribeCancels',
        $pb.PbFieldType.O3)
...
class NodeStatsRate extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.double>(
        4, _omitFieldNames ? '' : 'trackPublishAttempts', $pb.PbFieldType.OF)
    ..a<$core.double>(
        5, _omitFieldNames ? '' : 'trackPublishSuccess', $pb.PbFieldType.OF)
    ..a<$core.double>(
        6, _omitFieldNames ? '' : 'trackSubscribeAttempts', $pb.PbFieldType.OF)
    ..a<$core.double>(
        7, _omitFieldNames ? '' : 'trackSubscribeSuccess', $pb.PbFieldType.OF)
    ..a<$core.double>(8, _omitFieldNames ? '' : 'bytesIn', $pb.PbFieldType.OF)
    ..a<$core.double>(9, _omitFieldNames ? '' : 'bytesOut', $pb.PbFieldType.OF)
    ..a<$core.double>(
        10, _omitFieldNames ? '' : 'packetsIn', $pb.PbFieldType.OF)
    ..a<$core.double>(
        11, _omitFieldNames ? '' : 'packetsOut', $pb.PbFieldType.OF)
    ..a<$core.double>(
        12, _omitFieldNames ? '' : 'nackTotal', $pb.PbFieldType.OF)
    ..a<$core.double>(
        13, _omitFieldNames ? '' : 'sysPacketsOut', $pb.PbFieldType.OF)
    ..a<$core.double>(
        14, _omitFieldNames ? '' : 'sysPacketsDropped', $pb.PbFieldType.OF)
    ..a<$core.double>(
        15, _omitFieldNames ? '' : 'retransmitBytesOut', $pb.PbFieldType.OF)
    ..a<$core.double>(
        16, _omitFieldNames ? '' : 'retransmitPacketsOut', $pb.PbFieldType.OF)
    ..a<$core.double>(17, _omitFieldNames ? '' : 'participantSignalConnected',
        $pb.PbFieldType.OF)
    ..a<$core.double>(18, _omitFieldNames ? '' : 'participantRtcConnected',
        $pb.PbFieldType.OF)
    ..a<$core.double>(
        19, _omitFieldNames ? '' : 'participantRtcInit', $pb.PbFieldType.OF)
    ..a<$core.double>(20, _omitFieldNames ? '' : 'cpuLoad', $pb.PbFieldType.OF)
    ..a<$core.double>(
        21, _omitFieldNames ? '' : 'memoryLoad', $pb.PbFieldType.OF)
    ..a<$core.double>(
        22, _omitFieldNames ? '' : 'memoryUsed', $pb.PbFieldType.OF)
    ..a<$core.double>(
        23, _omitFieldNames ? '' : 'memoryTotal', $pb.PbFieldType.OF)
    ..a<$core.double>(
        24, _omitFieldNames ? '' : 'trackPublishCancels', $pb.PbFieldType.OF)
    ..a<$core.double>(
        25, _omitFieldNames ? '' : 'trackSubscribeCancels', $pb.PbFieldType.OF)
    ..a<$core.double>(
        26, _omitFieldNames ? '' : 'participantRtcCanceled', $pb.PbFieldType.OF)
    ..hasRequiredFields = false;
  ...
  static $pb.PbList<NodeStatsRate> createRepeated() =>
      $pb.PbList<NodeStatsRate>();
  @$core.pragma('dart2js:noInline')
...
class StartSession extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<$0.ReconnectReason>(
        17, _omitFieldNames ? '' : 'reconnectReason', $pb.PbFieldType.OE,
    ...
    ..pc<$2.AddTrackRequest>(
        21, _omitFieldNames ? '' : 'addTrackRequests', $pb.PbFieldType.PM,
...
class RoomInternal extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$4.RoomAgentDispatch>(
        5, _omitFieldNames ? '' : 'agentDispatches', $pb.PbFieldType.PM,
  ...
  static $pb.PbList<RoomInternal> createRepeated() =>
      $pb.PbList<RoomInternal>();
  @$core.pragma('dart2js:noInline')
...
class ICEConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..e<ICECandidateType>(
        1, _omitFieldNames ? '' : 'preferenceSubscriber', $pb.PbFieldType.OE,
        defaultOrMaker: ICECandidateType.ICT_NONE,
        valueOf: ICECandidateType.valueOf,
        enumValues: ICECandidateType.values)
    ..e<ICECandidateType>(
        2, _omitFieldNames ? '' : 'preferencePublisher', $pb.PbFieldType.OE,
        defaultOrMaker: ICECandidateType.ICT_NONE,
        valueOf: ICECandidateType.valueOf,
        enumValues: ICECandidateType.values)
    ..hasRequiredFields = false;
