...
class ConnectTwilioCallRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<ConnectTwilioCallRequest_TwilioCallDirection>(
        1, _omitFieldNames ? '' : 'twilioCallDirection', $pb.PbFieldType.OE,
        defaultOrMaker: ConnectTwilioCallRequest_TwilioCallDirection
            .TWILIO_CALL_DIRECTION_INBOUND,
        valueOf: ConnectTwilioCallRequest_TwilioCallDirection.valueOf,
        enumValues: ConnectTwilioCallRequest_TwilioCallDirection.values)
    ..aOS(2, _omitFieldNames ? '' : 'roomName')
    ..pc<$0.RoomAgentDispatch>(
        3, _omitFieldNames ? '' : 'agents', $pb.PbFieldType.PM,
  ...
  ConnectTwilioCallRequest clone() =>
      ConnectTwilioCallRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<ConnectTwilioCallRequest> createRepeated() =>
      $pb.PbList<ConnectTwilioCallRequest>();
  @$core.pragma('dart2js:noInline')
...
class ConnectTwilioCallResponse extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ConnectTwilioCallResponse clone() =>
      ConnectTwilioCallResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<ConnectTwilioCallResponse> createRepeated() =>
      $pb.PbList<ConnectTwilioCallResponse>();
  @$core.pragma('dart2js:noInline')
