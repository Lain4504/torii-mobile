...
class GenerateTokenReq extends $pb.GeneratedMessage {
  ...
  static $pb.PbList<GenerateTokenReq> createRepeated() =>
      $pb.PbList<GenerateTokenReq>();
  @$core.pragma('dart2js:noInline')
...
class WajlcTokenClaims extends $pb.GeneratedMessage {
  ...
  static $pb.PbList<WajlcTokenClaims> createRepeated() =>
      $pb.PbList<WajlcTokenClaims>();
  @$core.pragma('dart2js:noInline')
...
class LockSettings extends $pb.GeneratedMessage {
  ...
  static $pb.PbList<LockSettings> createRepeated() =>
      $pb.PbList<LockSettings>();
  @$core.pragma('dart2js:noInline')
...
class GenerateTokenRes extends $pb.GeneratedMessage {
  ...
  static $pb.PbList<GenerateTokenRes> createRepeated() =>
      $pb.PbList<GenerateTokenRes>();
  @$core.pragma('dart2js:noInline')
...
class CustomDesignParams extends $pb.GeneratedMessage {
  ...
  static $pb.PbList<CustomDesignParams> createRepeated() =>
      $pb.PbList<CustomDesignParams>();
  @$core.pragma('dart2js:noInline')
