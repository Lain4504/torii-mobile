...
class DataMsgBodyType extends $pb.ProtobufEnum {
  ...
  static const DataMsgBodyType PUSH_JOIN_BREAKOUT_ROOM =
      DataMsgBodyType._(7, _omitEnumNames ? '' : 'PUSH_JOIN_BREAKOUT_ROOM');
  ...
  static const DataMsgBodyType PAGE_CHANGE =
      DataMsgBodyType._(13, _omitEnumNames ? '' : 'PAGE_CHANGE');
  static const DataMsgBodyType FILE_CHANGE =
      DataMsgBodyType._(14, _omitEnumNames ? '' : 'FILE_CHANGE');
  static const DataMsgBodyType UPDATE_CURRENT_OFFICE_FILE_PAGES =
      DataMsgBodyType._(
          15, _omitEnumNames ? '' : 'UPDATE_CURRENT_OFFICE_FILE_PAGES');
  static const DataMsgBodyType WHITEBOARD_RESET =
      DataMsgBodyType._(16, _omitEnumNames ? '' : 'WHITEBOARD_RESET');
  static const DataMsgBodyType USER_CONNECTION_QUALITY_CHANGE =
      DataMsgBodyType._(
          17, _omitEnumNames ? '' : 'USER_CONNECTION_QUALITY_CHANGE');
  static const DataMsgBodyType REQ_PUBLIC_CHAT_DATA =
      DataMsgBodyType._(18, _omitEnumNames ? '' : 'REQ_PUBLIC_CHAT_DATA');
  static const DataMsgBodyType RES_PUBLIC_CHAT_DATA =
      DataMsgBodyType._(19, _omitEnumNames ? '' : 'RES_PUBLIC_CHAT_DATA');
  ...
  static const $core.List<DataMsgBodyType> values = <DataMsgBodyType>[
    ...
    REQ_PUBLIC_CHAT_DATA,
    RES_PUBLIC_CHAT_DATA,
  ];
