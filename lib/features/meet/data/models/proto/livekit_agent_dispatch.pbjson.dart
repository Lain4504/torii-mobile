...
import 'livekit_agent.pbjson.dart' as $5;
...
final $typed_data.Uint8List createAgentDispatchRequestDescriptor = $convert.base64Decode(
...
final $typed_data.Uint8List deleteAgentDispatchRequestDescriptor = $convert.base64Decode(
...
final $typed_data.Uint8List listAgentDispatchRequestDescriptor = $convert.base64Decode(
...
const ListAgentDispatchResponse$json = {
  ...
  '2': [
    {'1': 'agent_dispatches', '3': 1, '4': 3, '5': 11, '6': '.livekit.AgentDispatch', '10': 'agentDispatches'},
  ],
};

/// Descriptor for `ListAgentDispatchResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listAgentDispatchResponseDescriptor = $convert.base64Decode(
...
const AgentDispatch$json = {
  ...
  '2': [
    ...
    {'1': 'state', '3': 5, '4': 1, '5': 11, '6': '.livekit.AgentDispatchState', '10': 'state'},
  ],
};
...
const $core.Map<$core.String, $core.dynamic> AgentDispatchServiceBase$json = {
  ...
  '2': [
    {'1': 'CreateDispatch', '2': '.livekit.CreateAgentDispatchRequest', '3': '.livekit.AgentDispatch'},
    {'1': 'DeleteDispatch', '2': '.livekit.DeleteAgentDispatchRequest', '3': '.livekit.AgentDispatch'},
    {'1': 'ListDispatch', '2': '.livekit.ListAgentDispatchRequest', '3': '.livekit.ListAgentDispatchResponse'},
  ],
};

@$core.Deprecated('Use agentDispatchServiceDescriptor instead')
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> AgentDispatchServiceBase$messageJson = {
  ...
  '.livekit.JobState': $5.JobState$json,
