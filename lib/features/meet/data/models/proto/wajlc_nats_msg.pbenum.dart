...
class NatsMsgServerToClientEvents extends $pb.ProtobufEnum {
  ...
  static const NatsMsgServerToClientEvents BREAKOUT_ROOM_ENDED =
      NatsMsgServerToClientEvents._(
          14, _omitEnumNames ? '' : 'BREAKOUT_ROOM_ENDED');
  static const NatsMsgServerToClientEvents SYSTEM_CHAT_MSG =
      NatsMsgServerToClientEvents._(
          15, _omitEnumNames ? '' : 'SYSTEM_CHAT_MSG');
  static const NatsMsgServerToClientEvents TRANSCRIPTION_OUTPUT_TEXT =
      NatsMsgServerToClientEvents._(
          16, _omitEnumNames ? '' : 'TRANSCRIPTION_OUTPUT_TEXT');
  static const NatsMsgServerToClientEvents RESP_INSIGHTS_AI_TEXT_CHAT =
      NatsMsgServerToClientEvents._(
          17, _omitEnumNames ? '' : 'RESP_INSIGHTS_AI_TEXT_CHAT');
  static const NatsMsgServerToClientEvents RESP_ONLINE_USERS_LIST =
      NatsMsgServerToClientEvents._(
          18, _omitEnumNames ? '' : 'RESP_ONLINE_USERS_LIST');
  static const NatsMsgServerToClientEvents DELIVERY_PRIVATE_DATA =
      NatsMsgServerToClientEvents._(
          19, _omitEnumNames ? '' : 'DELIVERY_PRIVATE_DATA');
  ...
  static const $core.List<NatsMsgServerToClientEvents> values =
    ...
    RESP_ONLINE_USERS_LIST,
    DELIVERY_PRIVATE_DATA,
  ];
...
class NatsMsgClientToServerEvents extends $pb.ProtobufEnum {
  ...
  static const NatsMsgClientToServerEvents REQ_MEDIA_SERVER_DATA =
      NatsMsgClientToServerEvents._(
          1, _omitEnumNames ? '' : 'REQ_MEDIA_SERVER_DATA');
  static const NatsMsgClientToServerEvents REQ_JOINED_USERS_LIST =
      NatsMsgClientToServerEvents._(
          2, _omitEnumNames ? '' : 'REQ_JOINED_USERS_LIST');
  static const NatsMsgClientToServerEvents REQ_RENEW_WAJLC_TOKEN =
      NatsMsgClientToServerEvents._(
          3, _omitEnumNames ? '' : 'REQ_RENEW_WAJLC_TOKEN');
  static const NatsMsgClientToServerEvents PING =
      NatsMsgClientToServerEvents._(4, _omitEnumNames ? '' : 'PING');
  static const NatsMsgClientToServerEvents REQ_RAISE_HAND =
      NatsMsgClientToServerEvents._(5, _omitEnumNames ? '' : 'REQ_RAISE_HAND');
  static const NatsMsgClientToServerEvents REQ_LOWER_HAND =
      NatsMsgClientToServerEvents._(6, _omitEnumNames ? '' : 'REQ_LOWER_HAND');
  static const NatsMsgClientToServerEvents REQ_LOWER_OTHER_USER_HAND =
      NatsMsgClientToServerEvents._(
          7, _omitEnumNames ? '' : 'REQ_LOWER_OTHER_USER_HAND');
  static const NatsMsgClientToServerEvents PUSH_ANALYTICS_DATA =
      NatsMsgClientToServerEvents._(
          8, _omitEnumNames ? '' : 'PUSH_ANALYTICS_DATA');
  static const NatsMsgClientToServerEvents REQ_ONLINE_USERS_LIST =
      NatsMsgClientToServerEvents._(
          9, _omitEnumNames ? '' : 'REQ_ONLINE_USERS_LIST');
  static const NatsMsgClientToServerEvents REQ_PRIVATE_DATA_DELIVERY =
      NatsMsgClientToServerEvents._(
          10, _omitEnumNames ? '' : 'REQ_PRIVATE_DATA_DELIVERY');
  ...
  static const $core.List<NatsMsgClientToServerEvents> values =
    ...
    PUSH_ANALYTICS_DATA,
    REQ_ONLINE_USERS_LIST,
    REQ_PRIVATE_DATA_DELIVERY,
  ];
