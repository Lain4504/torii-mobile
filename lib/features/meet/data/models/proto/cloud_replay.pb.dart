...
class ListReplaysRequest extends $pb.GeneratedMessage {
  ...
  static $pb.PbList<ListReplaysRequest> createRepeated() =>
      $pb.PbList<ListReplaysRequest>();
  @$core.pragma('dart2js:noInline')
...
class ListReplaysResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'replay'),
      createEmptyInstance: create)
    ..pc<ReplayInfo>(1, _omitFieldNames ? '' : 'replays', $pb.PbFieldType.PM,
  ...
  static $pb.PbList<ListReplaysResponse> createRepeated() =>
      $pb.PbList<ListReplaysResponse>();
  @$core.pragma('dart2js:noInline')
...
class DeleteReplayRequest extends $pb.GeneratedMessage {
  ...
  static $pb.PbList<DeleteReplayRequest> createRepeated() =>
      $pb.PbList<DeleteReplayRequest>();
  @$core.pragma('dart2js:noInline')
...
class PlaybackResponse extends $pb.GeneratedMessage {
  ...
  static $pb.PbList<PlaybackResponse> createRepeated() =>
      $pb.PbList<PlaybackResponse>();
  @$core.pragma('dart2js:noInline')
...
class ClosePlaybackRequest extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ClosePlaybackRequest clone() =>
      ClosePlaybackRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<ClosePlaybackRequest> createRepeated() =>
      $pb.PbList<ClosePlaybackRequest>();
  @$core.pragma('dart2js:noInline')
