          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  _buildTopUser('Huy Nguyen', '520 XP', 'https://i.pravatar.cc/150?u=2', 2, AppColors.textTertiary),
                  _buildTopUser('Minh Tran', '840 XP', 'https://i.pravatar.cc/150?u=1', 1, AppColors.accent),
                  _buildTopUser('Linh Pham', '480 XP', 'https://i.pravatar.cc/150?u=3', 3, AppColors.detail),
                ],
              ),
            ),
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return _buildLeaderboardRow(rank, isMe);
                },
              ),
            ),
  ...
  Widget _buildTopUser(String name, String xp, String avatarUrl, int rank, Color color) {
    ...
    return Column(
      children: [
        ...
        Text(xp, style: const TextStyle(color: AppColors.primary, fontWeight: FontWeight.bold, fontSize: 12)),
      ],
    );
  }

  Widget _buildLeaderboardRow(int rank, bool isMe) {
    return Container(
      ...
      child: Row(
        children: [
          SizedBox(
            width: 30,
            child: Text('#$rank', style: TextStyle(fontWeight: FontWeight.bold, color: AppColors.grey700)),
          ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text('Cấp độ N5', style: TextStyle(color: AppColors.grey700, fontSize: 11)),
              ],
            ),
          ),
          Text('420 XP', style: TextStyle(fontWeight: FontWeight.bold, color: isMe ? AppColors.primary : AppColors.textPrimary)),
        ],
      ),
    );
  }
